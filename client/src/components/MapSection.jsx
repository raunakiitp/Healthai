        ...
        try {
          ...
          new window.google.maps.Marker({
            ...
            icon: {
              ...
              scale: 10, fillColor: "#3b96f2", fillOpacity: 1,
            ...
            {!HAS_KEY ? (
              <div className="h-80 flex items-center justify-center flex-col gap-4 p-8 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">client/.env</code>
                    <br />
              ...
              <div className="h-80 flex items-center justify-center flex-col gap-4 p-8 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Allow location access to find hospitals near you.</p>
                </div>
              </div>
            ) : (
              <>
