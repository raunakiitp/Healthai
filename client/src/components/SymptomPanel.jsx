...
export default function SymptomPanel({ formData, onChange, onAnalyze, isLoading }) {
  ...
  const toggleSymptom = (sym) => {
    if (symptoms.includes(sym)) {
      onChange({ symptoms: symptoms.filter((s) => s !== sym) });
    } else {
  ...
  return (
    <section id="symptom-panel" className="py-16 px-4 sm:px-6">
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="font-semibold text-gray-700 dark:text-gray-200 mb-4 flex items-center gap-2">
                ...
                Select Symptoms
                {symptoms.length > 0 && (
                  <span className="ml-auto text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 px-2 py-1 rounded-full">
